...
public class Divider implements FunctionalUnit{
	...
	public Divider(boolean if_pipeline, int cycle_count) {
		
		Divider.cycle_count=cycle_count;
		Divider.if_pipeline=if_pipeline;
	}
